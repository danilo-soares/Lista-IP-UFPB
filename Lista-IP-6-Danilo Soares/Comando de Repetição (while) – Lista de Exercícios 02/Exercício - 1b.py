...
#somando 1 fazendo com que no final não seja o valor de quantos numeros são posi
#tivos e por ultimo temos que colocar um else caso o numero for menor que 0.
